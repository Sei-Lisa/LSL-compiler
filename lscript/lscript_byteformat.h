...
typedef enum e_lscript_state_event_type
{
	...
	LSTT_PATH_UPDATE,
	LSTT_EXPERIENCE_PERMISSIONS,
	LSTT_EXPERIENCE_PERMISSIONS_DENIED,
	LSTT_EOF,
...
const U64 LSCRIPTStateBitField[LSTT_EOF] =
{
	...
	0x0000000400000000LL,	// LSTT_TRANSACTION_RESULT
	0x0000000800000000LL,	// LSTT_PATH_UPDATE
	0x0000001000000000LL,	// LSTT_EXPERIENCE_PERMISSIONS
	0x0000002000000000LL,	// LSTT_EXPERIENCE_PERMISSIONS_DENIED
};
